...
-- Q3: Oops! Someone spelled Krusty The Clown's name wrong! 
-- Change it to reflect the proper spelling (Crusty should be Krusty).
-- UPDATE people SET name = 'Krusty the Clown' WHERE name = 'Crusty the Clown'; 
-- SELECT * FROM people;

-- Q4: Return ONLY Homer Simpson's name from the 'people' table.
-- SELECT name FROM people WHERE name = 'Homer Simpson';

-- Q5: The cinema is showing 'Batman Begins', but Batman is DC, not Marvel! 
-- Delete the entry from the 'movies' table.
...
-- Q7: Eric Cartman has decided to hijack our movie evening, 
-- Remove him from the table of people.
-- DELETE FROM people WHERE name = 'Eric Cartman'

-- Q8: The cinema has just heard that they will be holding an exclusive midnight 
-- showing of 'Avengers: Infinity War'!! Create a new entry in 
-- the 'movies' table to reflect this.
-- INSERT INTO movies (title, year, show_time) VALUES ('Avengers: Infinity War', 2019, '8PM');
-- SELECT * FROM movies;

-- Q9: The cinema would like to make the Iron Man movies a triple billing. 
-- Find out the show time of "Iron Man 2" and set the show time 
-- of "Iron Man 3" to start two hours later.
